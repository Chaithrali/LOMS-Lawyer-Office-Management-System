...
$id=$_GET['id'];
$stmt=$admin->ret("SELECT * FROM bill where caseid=".$id);
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                          ...
                          <form action="../../controller/payment.php" method="POST"enctype="multipart/form-data">
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                                   <input type="hidden" id="company" required="" name="id" value="<?php echo $row['caseid'];?>"   placeholder="Enter the Bill No"class="form-control">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" id="company" required="" name="transno"   placeholder="Enter the transaction No"class="form-control">
                                        </div>
                                        
                                        </div>
                                       
                                         <div class="container-login100-form-btn"style="margin-left:300px;">
                                            <button type="submit" class="btn btn-primary"  name="addpay">
                                            ADD
                                            </button>
