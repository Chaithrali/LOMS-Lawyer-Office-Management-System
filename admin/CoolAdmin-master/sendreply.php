            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <textarea id="company" name="reply"  class="form-control"rows="5"></textarea>
                                            <input type="hidden" name="id" value="<?php echo $id;?>">
                                            <input type="hidden" name="cid" value="<?php echo $row['clientid'];?>">
                        ...
                        <button type="submit" class="btn btn-danger"  name="sendreply">
                            Send Query
                        </button>
