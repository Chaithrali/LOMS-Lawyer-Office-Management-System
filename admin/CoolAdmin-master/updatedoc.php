...
$stmt=$admin->show_id("document","doc_id",$id);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <form action="../../controller/updatedoc.php" method="POST" enctype="multipart/form-data">
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">Case</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company" name="doctype" placeholder="Enter the doc type" value="<?php echo $row['doctype'];?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                                    <label for="city" class=" form-control-label">File_Path</label>
                                                    <input type="text" id="company" name="filepath" placeholder="Enter the doc type" value="<?php echo $row['filepath'];?>" class="form-control">
                                        </div>        
                                                <!-- <select name="casesubject" class="form-control">
                                                        
                                                     <optgroup label="Selected" > 
                                                            <option value="<?php echo $row['casesubject'];?>" ><?php echo $row['casesubject'];?></option>
                                                            </optgroup>
                                                            ...
                                                            <option value="SCST&IPC">SCST&IPC</option>
                                                            <option  value="Grant Of Land">Grant Of Land</option>
                                                            </optgroup>
                                        ...
                                        <!-- <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="city"name="casedetail" placeholder="Enter the case detail" value="<?php echo $row['casedetail'];?>" class="form-control">
                                                </div> -->
                                       <!--  <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="party_type" class="form-control">
                                                    <optgroup label="Selected" > 
                                                            <option value="<?php echo $row['party_type'];?>" ><?php echo $row['party_type'];?></option>
                                                    </optgroup>
                                                             <optgroup label="Other options">
                                                            <option value="Respond">Respond</option>
                                                            <option value="Pitioner">Pitioner</option>
                                                            <option value="Defendent No 43">Defendent No 43</option>
                                                            <option value="Accused No 2">Accused No 2</option>
                                                            <option value="Plaintiff">Plaintiff</option>
                                                            <option value="Complainant">Complainant</option>
                                                            <option value="Defendents">Defendents</option>
