...
<body class="animsition">
    <div class="page-wrapper">
       ...
       <?php include "header.php";?>
        ...
        <!-- PAGE CONTAINER-->
        <div class="page-container" style="background:url('images/15.jpg');">
            <!-- HEADER DESKTOP-->
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                             <br><h1 style="font-family:cursive"><br>CASE TABLE</h1>
    ...
    while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        <td><a href="Updatecase.php?id=<?php echo $row['cid']; ?>" class="btn btn-info">Update</a></td>
         ...
         <td><a href="addhearing2.php?id=<?php echo $row['cid'];?>&id2=<?php echo $row['u_id'];?>" class="btn btn-success">Hearing</a></td>
