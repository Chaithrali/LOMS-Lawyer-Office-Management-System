...
<body class="animsition">
    ...
    while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        <td><a href="Deletedoc.php?id=<?php echo $row['cid']; ?>" onclick="return confirm('are you sure');" class="btn btn-danger">Delete</a></td>
                        
        <td><a href="Updatedoc.php?id=<?php echo $row['cid']; ?>" class="btn btn-info">Update</a></td>
