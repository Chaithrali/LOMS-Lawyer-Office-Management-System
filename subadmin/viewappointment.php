                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-data2">
                                        ...
                                        <tbody id="example">
    <?php
    $stmt=$admin->ret("SELECT * FROM `appointment` INNER JOIN associate on appointment.associateid=associate.associateid INNER join user on user.u_id=appointment.clientid");
