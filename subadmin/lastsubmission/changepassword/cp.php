            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-4 col-lg-9 offset-lg-3">
                    <div class="section-title text-center">
                        <h3 class="color-72 fw-500">Change Password</h3>
                    </div>

                    <div class="booking-wrapper mt-45">
                        <form action="" method="post" class="clearfix">
                            <div class="single-input name">
                                <input type="password" name="opwd" placeholder="Current password" required />
                            </div>
                            ...
                            <div class="single-input phone">
                                <input type="password" name="cpwd" placeholder="confirm password" / autocomplete="off">
                            </div>

                            
                            <button type="submit" name="change">Change</button>
                            <button type="reset" name="Cancle">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php
     ...
     $uid=$_SESSION['consumer'];
      ...
      if(isset($_POST['change']))
      {
            ...
            $npwd=$_POST['npwd'];
            $cpwd=$_POST['cpwd'];
            $sql=mysqli_query($con,"SELECT * from consumer
      where cid='$uid' and password='$opwd'") or die(mysql_error($con));
            $nrows=mysqli_num_rows($sql);
            if($nrows==1)
            {
                  if($npwd==$cpwd)
                  {
                        $qry=mysqli_query($con,"update consumer set password='$npwd' where cid='$uid'") or die(mysqli_error($con));
                        if($qry)
                        {
