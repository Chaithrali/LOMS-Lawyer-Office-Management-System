                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <form action="../controller/updatecase1.php" method="POST" enctype="multipart/form-data">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company" name="clientname" placeholder="Enter the client name" value="<?php echo $row['clientname'];?>" class="form-control">
                                        </div>
                                        <div class="form-group">
