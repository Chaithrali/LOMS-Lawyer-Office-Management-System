                          ...
                          <form action="../controller/addassociate1.php" method="POST"enctype="multipart/form-data">
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company" name="lawyer_name"   placeholder="Enter the lawyer name"class="form-control">
                                        </div>

                                         <div class="form-group">
                                            <label for="company" class=" form-control-label">WorkProfile</label>
                                            <!-- <input type="hidden" name="id" value="<?php #echo $row['cid'];?>"> -->
                                            <input type="text" id="company" name="workprofile"   placeholder="Enter the lawyer qualification"class="form-control">
                                        </div>

                                         <div class="form-group">
                                            <label for="vat" class=" form-control-label">Image</label>
                                            <input type="file" id="vat" name="image"  placeholder="Enter the user name" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="postal-code"name="expertise" placeholder="Enter the email-id" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" id="country" name="experience" placeholder="Enter the contact number" class="form-control">
                                        </div>
