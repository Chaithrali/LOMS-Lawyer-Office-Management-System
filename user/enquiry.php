            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong><b>Send Query</b></strong>
                                       
                                    </div>
                                    <form action="../controller/query.php" method="POST">
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label"><b>Any Queries?</b></label>
                                            <!-- <input type="tex" id="company" name="title"  class="form-control"> -->
                                            <textarea id="company" name="qry"  class="form-control"rows="5"></textarea>
                        ...
                        <button type="submit" class="btn btn-danger"  name="sendquery">
                            Send Query
                        </button>
