...
<body class="animsition">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus" onclick="abc()"></i>add case</button>
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-data2">
                                        ...
                                        <tbody id="example">
    <?php
    $stmt=$admin->ret("SELECT * FROM `appointment` INNER JOIN associate on appointment.associateid=associate.associateid INNER join user on user.u_id=appointment.clientid where appointment.clientid=".$cid);
    while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        ';?>
                <!-- <td><a href="addcase.php" class="btn btn-info"></a></td> -->
