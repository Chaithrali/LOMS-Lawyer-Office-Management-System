                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-data2">
                                        ...
                                        <tbody id="example">
    <?php
    $stmt=$admin->ret("SELECT * FROM `enquiry` INNER JOIN associate on enquiry.associateid=associate.associateid INNER join user on user.u_id=enquiry.clientid where enquiry.clientid=".$cid);
