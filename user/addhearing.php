                        ...
                        <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>ADD Case Hearing</strong>
                                        <small> Form</small>
                                    </div>
                                     <form action="../../controller/addcase1.php" method="POST">
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">Case_Id</label>
                                            <input type="text" id="company" name="caseid" placeholder="CC3107/2017" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Client Name</label>
                                            <input type="text" id="vat" name="clientname" placeholder="Enter the client name" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="postal-code"name="hearingdate" placeholder="Enter the hearing date" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="country" class=" form-control-label">Court Name</label>
                                            <input type="text" id="country" name="courtname" placeholder="Enter the court name" class="form-control">
                                        </div>
