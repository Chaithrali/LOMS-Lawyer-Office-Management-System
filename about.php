                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12">
                                                            <div class="form_wrap d-flex">
                                                               <!-- <h1> style="color:white;">What is LOMS?</h1>

 -->
                                                                <p>LOMS:-"Lawyer Office Management System" is a site where a user can search for particular lawyer they need. User can login the site and take the appointment of the required lawyer. User can also ask any queries.Using this site the user can view the lawyers information.After the appointment is confirmed the user can send the case documents .Then the admin can look after the further process.The admin can send next hearing date, payment details through notification. The user can pay the bill through online like using card or cash </p> 
